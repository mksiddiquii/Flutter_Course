void main() {
  ...
  for (int i = 0; i < fruits.length; i++) {
    print("Fruit name at index $i : ${fruits[i]}");
  }
  //FOR IN LOOP
  ...
  for (var i in users) {
    ...
    Email Adrress: ${i["email"]}
    Lat: ${i["address"]["geo"]["lat"]}
    Lag: ${i["address"]["geo"]["lng"]}
    """);
    print("=" * 50);
  };
  //FUNCTIONS
