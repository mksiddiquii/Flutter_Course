          ...
          Expanded(
            ...
            child: SingleChildScrollView(
              child: Column(
               ...
               Msg_person("Quraan FM", "https://miro.medium.com/v2/resize:fit:1100/format:webp/1*X756QALdNl_lNYmFumCpzg.jpeg","Indeed, with hardship comes ease.particularly for his expertise in the specialty of Quranic recitation, or Tajweed. His melodic voice, exactness, and basic impression of the Quran have made him one of the most respected and regarded Qaris from one side of the world to the other.")
